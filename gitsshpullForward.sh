#ssh -p 3164 sr-projekt-load-balancer@h2899502.stratoserver.net "cd /mys-projekt-load-balancer-auto-scaler ; bash --login; git reset --hard HEAD && git pull"
...
ssh -t -p 3154 -p "abc123!" sr-projekt-execs-1@h2899502.stratoserver.net "cd ~/mys-projekt-load-balancer-auto-scaler ; git reset --hard HEAD && git pull"
